            ...
            <div class="col-md">
                <div class="ftco-footer-widget mb-4">
                    ...
                    <ul class="ftco-footer-social list-unstyled float-md-left float-lft mt-5">
                        <li class="ftco-animate"><a href="{{ $biodata->fb }}"><span class="icon-facebook"></span></a></li>
                        <li class="ftco-animate"><a href="{{ $biodata->ig }}"><span class="icon-instagram"></span></a></li>
                        <li class="ftco-animate"><a href="{{ $biodata->github }}"><span class="icon-github"></span></a></li>
                    </ul>
                </div>
            </div>
            <div class="col-md">
