                    ...
                    <form method="POST" action="{{ route('biodata.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-2">
                            ...
                            <input type="url" class="form-control" name="ig" id="exampleInputEmail1"
                                aria-describedby="emailHelp" placeholder="Url Instagram">
                        </div>
                        <div class="mb-2">
                            ...
                            <input type="url" class="form-control" name="fb" id="exampleInputEmail1"
                                aria-describedby="emailHelp" placeholder="Url Facebook">
                        </div>
                        <div class="mb-2">
                            ...
                            <input type="url" class="form-control" name="github" id="exampleInputEmail1"
                                aria-describedby="emailHelp" placeholder="Url Github">
                        </div>
                        <div class="mb-2">
