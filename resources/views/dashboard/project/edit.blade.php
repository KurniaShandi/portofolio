                ...
                <div class="card-body">
                    <div class="row my-3">
                        ...
                        <div class="col d-flex justify-content-end">
                            <h5 class="card-title fw-semibold mb-1 d-inline">Update Project</h5>
                        </div>
                    </div>
                    <form method="POST" action="{{ route('project.update', $data->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-2">
                            ...
                            <input type="text" class="form-control" name="nama_projek" id="exampleInputEmail1"
                                aria-describedby="emailHelp" placeholder="Nama Project..." value="{{ $data->nama_projek }}"
                                required>
                        </div>
                        <div class="mb-2">
                            ...
                            <textarea name="keterangan" class="form-control" id="" cols="30" rows="10"
                                placeholder="Keterangan Project.." required>{{ $data->keterangan }}</textarea>
                        </div>
                        <div class="my-3">
